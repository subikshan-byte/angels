...
urlpatterns = [
    ...
    path('cart/add/<slug:product_id>/', views5.add_to_cart, name='add to cart'),
    path('verify-order-otp/', views6.verify_order_otp, name='verify_order_otp'),

path('cart/update/<int:cart_item_id>/', views5.update_cart_quantity, name='add_to_cart'),
...
path('verify-order-otp-cart/', views7.verify_order_otp, name='verify_order_otp1'),
    ...
    path('payment/success-cart1/', views7.payment_success_cart, name='payment_success1'),
...
path("apply-coupon1/", views6.apply_coupon1, name="apply_coupon1"),
